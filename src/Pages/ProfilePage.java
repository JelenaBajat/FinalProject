...
public class ProfilePage extends BasicPage{
	...
	public void changeAllInfo(String name, String lastName, String address, String phoneNo, String zipCode, String country, String state, String city) throws InterruptedException {
		this.getName().clear();
		...
		Thread.sleep(2000);
		this.getState().selectByVisibleText(city);
